...
ตอบ 1.ใน Single Task System เมื่อกดปุ่ม อาจต้องรอให้งานหลักทำงานเสร็จก่อน จึงจะตอบสนองได้ → ทำให้รู้สึก “หน่วง” หรือ “ช้า”
2.ใน Multitasking System การตอบสนองปุ่มจะเร็วกว่า เพราะระบบสามารถจัดสรรเวลาให้หลายงานทำงานพร้อมกัน
2. ใน Single Task System งานไหนที่ทำให้การตอบสนองล่าช้า?
ตอบ 1.งานหลักที่ใช้เวลาประมวลผลนาน เช่น การคำนวณ การแสดงผล หรือการหน่วงเวลา (delay) ทำให้โปรแกรมไม่สามารถตรวจจับการกดปุ่มได้ทันที
3. ข้อดีของ Multitasking System ที่สังเกตได้คืออะไร?
ตอบ 1.ระบบสามารถทำงานหลายอย่างได้พร้อมกัน เช่น แสดงผลอยู่ในขณะเดียวกันกับตรวจปุ่ม การตอบสนองรวดเร็วกว่า
2.ทำให้โปรแกรมดู “ลื่นไหล” และ “โต้ตอบได้ดี”
4. มีข้อเสียของ Multitasking System ที่สังเกตได้หรือไม่?
ตอบ 1.มีความซับซ้อนมากขึ้นในการเขียนโปรแกรม (ต้องจัดการ Task และการสื่อสารระหว่าง Task) ใช้หน่วยความจำมากกว่า หากจัดสรรเวลาไม่ดีอาจเกิดการแย่งทรัพยากร (resource conflict)
